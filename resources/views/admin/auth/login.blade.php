...
<body class="bg-primary text-foreground h-screen flex items-center justify-center p-6 selection:bg-accent/30" data-theme="dark">
    <div class="w-full max-w-md animate-scale-in">
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-surface rounded-2xl shadow-xl border border-border mb-6">
        ...
        <div class="glass-dark p-10 rounded-3xl shadow-dashboard border border-border">
            <form action="{{ route('admin.login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required class="w-full pl-12 pr-6 py-4 bg-surface text-foreground border border-border rounded-2xl focus:border-accent outline-none transition-all" placeholder="admin@blogyaari.com">
                    </div>
                    @error('email')
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" required class="w-full pl-12 pr-6 py-4 bg-surface text-foreground border border-border rounded-2xl focus:border-accent outline-none transition-all" placeholder="••••••••">
                    </div>
                </div>
                ...
                <button type="submit" class="w-full py-4 bg-accent text-white rounded-2xl font-bold shadow-xl shadow-accent/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
                    Sign In
                </button>
            </form>
        </div>
