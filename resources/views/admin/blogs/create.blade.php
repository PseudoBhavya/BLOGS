        ...
        <div class="glass p-10 rounded-3xl shadow-sm">
            <div class="space-y-8">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required class="w-full px-6 py-4 bg-surface border border-border rounded-2xl focus:border-accent focus:bg-surface outline-none transition-all text-xl font-bold text-foreground" placeholder="The Future of Smarter Blogging...">
                ...
                <div>
                    ...
                    <textarea name="short_description" required rows="3" class="w-full px-6 py-4 bg-surface border border-border rounded-2xl focus:border-accent focus:bg-surface outline-none transition-all resize-none text-foreground" placeholder="A brief hook for your readers...">{{ old('short_description') }}</textarea>
                </div>

                <div>
                    <label class="block text-sm font-bold mb-3">Full Article Content</label>
                    <textarea name="content" required rows="15" class="w-full px-6 py-4 bg-surface border border-border rounded-2xl focus:border-accent focus:bg-surface outline-none transition-all text-foreground" placeholder="Write your story here...">{{ old('content') }}</textarea>
    ...
    <div class="space-y-6">
        <div class="glass p-8 rounded-3xl shadow-sm">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="date" name="publish_date" value="{{ date('Y-m-d') }}" required class="w-full px-4 py-3 bg-surface border border-border rounded-xl focus:border-accent focus:bg-surface outline-none transition-all text-sm text-foreground">
                </div>
        ...
        <div class="glass p-8 rounded-3xl shadow-sm">
            ...
            <div>
                ...
                <input type="url" name="featured_image" id="image_url" class="w-full px-4 py-3 bg-surface border border-border rounded-xl focus:border-accent focus:bg-surface outline-none transition-all text-sm mb-4 text-foreground" placeholder="https://images.unsplash.com/...">
